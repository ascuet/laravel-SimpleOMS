...
class Authorize{
	...
	protected function setRoles(){
		$actions=[
			...
			'OrderController@getExport'=>[0,1,2],
			'OrderController@postReady'=>[0,1,2],
			'OrderController@postCombine'=>[0,3],
			'OrderController@postUnbind'=>[0,3],
			'OrderController@postCancel'=>[0,1,2],
			'OrderController@postSend'=>[0,3],
			'OrderController@postFinish'=>[0,3],
			'OrderController@postBackward'=>[0,1,2],
			'OrderController@postToggleStar'=>[0,1,2,3],
			'OrderController@index'=>[0,1,2,3,4,5],
			'OrderController@create'=>[0,1,2],
			'OrderController@store'=>[0,1,2],
			'OrderController@edit'=>[0,1,2,3,4,5],
			'OrderController@update'=>[0,1,2,5],
			...
			'ProductController@getEntry'=>[0,3],
			'ProductController@postEntry'=>[0,3],
			'ProductController@getSelecttable'=>[0,3],
