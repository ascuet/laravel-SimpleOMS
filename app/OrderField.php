	...
	protected function setFields($method){
		switch ($method) {
			...
			case 'add':
				...
				$this->setFieldsBatch('add',['radio'=>'required|event:change_deliver|default:1'],['is_deliver'],[''],[0,1,2]);
			...
			case 'edit':
				...
				$this->setFieldsBatch('edit',['text'=>'required'],['country'],[2,3],[0,2]);
				$this->setFieldsBatch('edit',['text'=>'required|readonly'],['country'],[2,3],[1]);
				...
				$this->setFieldsBatch('edit',['decimal'=>'required'],['sum'],[0,1],[1]);
				$this->setFieldsBatch('edit',['decimal'=>'required'],['sum'],[0,1,2,3,-1],[0,2]);
				$this->setFieldsBatch('edit',['decimal'=>'required|readonly'],['sum'],[2,3,-1],[1]);
				...
				$this->setFieldsBatch('edit',['radio'=>'required|event:change_deliver|default:1'],['is_deliver'],[0,1],[0,1,2]);
